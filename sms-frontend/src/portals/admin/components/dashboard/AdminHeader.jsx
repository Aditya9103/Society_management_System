                ...
                <div className="flex items-center gap-4 w-full lg:w-auto overflow-x-auto pb-2 lg:pb-0 justify-end">
                    ...
                    >
                        ...
                        <input 
                            ...
                            readOnly
                            className="w-full bg-[#13151a] border border-white/5 rounded-xl pl-10 pr-12 py-2 text-sm text-white placeholder-gray-300 font-bold cursor-pointer focus:outline-none focus:ring-1 focus:ring-indigo-500/50 hover:bg-white/5 transition-colors"
                        />
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 px-1.5 py-0.5 rounded border border-white/10 bg-white/5 text-[12px] text-gray-400 font-mono pointer-events-none">
                            ⌘ K
                        </div>
                    </div>

                    {/* Theme Toggle (Visual only for now if dark is forced) */}
                    <button className="shrink-0 p-2 rounded-xl border border-white/5 bg-[#13151a] text-gray-300 hover:text-white hover:border-white/10 transition-colors">
                        <Sun className="w-4 h-4" />
                    </button>
                    
                    {/* Messages / Complaints */}
                    <Link to="/admin/complaints" className="shrink-0 p-2 rounded-xl border border-white/5 bg-[#13151a] text-gray-300 hover:text-white hover:border-white/10 transition-colors relative">
