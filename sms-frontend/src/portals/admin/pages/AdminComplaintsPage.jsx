...
import { useGetAllComplaintsQuery } from '../../../store/api/societyAdminApi';
...
export default function AdminComplaintsPage() {
    ...
    const { data, isLoading, isError, refetch, isFetching } = useGetAllComplaintsQuery({
        page, limit, search,
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-[14px] font-bold text-gray-300">
                        Review, assign, and resolve all society complaints
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    <button
                    ...
                    <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#6338f0] hover:bg-[#5b32e6] text-white font-bold transition-all shadow-[0_0_15px_rgba(99,56,240,0.3)]">
