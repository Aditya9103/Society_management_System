...
import { 
    ArrowLeft, Download, AlertTriangle, MessageSquare, Clock, 
    CheckCircle, Archive, ChevronDown, Zap, 
    Droplets, Shield, HelpCircle, Settings, Volume2, Car, Wrench 
} from 'lucide-react';
import { 
...
export default function StaffComplaintDetailsPage() {
    ...
    const { data, isLoading, isError, refetch } = useGetStaffComplaintByIdQuery(id);
    const [changeStatus, { isLoading: isUpdating }] = useStaffChangeComplaintStatusMutation();
            ...
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                <div>
                    <div className="flex items-center gap-2 text-[12px] font-bold text-gray-400 mb-2">
                        <Link to="/staff/complaints" className="hover:text-white transition-colors flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="md:col-span-2 flex flex-col h-full">
                                ...
                                <div className="flex items-center justify-between mt-3">
                                    <span className="text-[11px] font-bold text-gray-500">This note will be logged in the timeline.</span>
                                    <button 
